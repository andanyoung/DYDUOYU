...
#define URLStr @"http://www.douyutv.com/api/v1/live/1?&auth=57d96c66116afaada1d7e471c0949d97&limit=20&client_sys=ios&aid=ios"
...
{
    //http://www.douyutv.com/api/v1/live/1?&auth=57d96c66116afaada1d7e471c0949d97&limit=20&client_sys=ios&aid=ios
    //获取房间列表
    NSLog(@"你点击了 %ld--%ld",(long)indexPath.section,indexPath.item);
    OnlineViewController *onlineVC = [[OnlineViewController alloc]initWithColumnModel:_dataArray[indexPath.row]];
